        ...
        try {
            ...
            switch (cmd) {
                ...
                case 'test':                   // run CPU test
                    ...
                    switch (this.emu.memo.type) {
                        ...
                        case 2:
                            ...
                            switch (pi(parms[1])) {
                                case 0:
                                    this.emu.memo.con.print('all valid opcodes test:_');
                                    await delay(0);
                                    ...
                                    this.emu.memo.con.print(
                                        (this.emu.CPU.cpu.getPC() === 0x3469) ? 'ok~' : 'error~'
                                    );
                                    break;
                                case 1:
                                    ...
                                    this.emu.memo.wr = (a, v) => {
                                        if (a === 0xf000)
                                            this.emu.memo.con.display(v); // $F000 - console output
                                        else sav.call(this.emu.memo, a, v);
                                    };
                                    this.emu.memo.con.print('extended opcodes test:~');
                                    await delay(0);
                                    ...
                                    break;
                                case 2:
                                    this.emu.memo.con.print('interrupts test:_________');
                                    await delay(0);
                        ...
                        case 4:
                            ...
                            if (tmp === 'jmpmov')
                                ...
                                this.emu.memo.con.print((tmp.length === 0) ?
                                        'ok~' : `error_(${tmp})~`);
                            }
                            break;
                    }
                ...
                case 'help':
                    ...
                    term.print(
                    '                     scope panel; msk - bit mask, clr - color, wdt - width');
...
async function main() {
    ...
    const con = await createCon(blue, 'VT220', 40),
          mem = new ExtMemIO(con, 1, false),
