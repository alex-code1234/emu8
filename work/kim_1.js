...
async function main() {
    let loads = [
        loadImage('../emu/github/emu8/kim1/KIM-1.jpg'), loadScript('../emu/github/emu8/js/js6502.js'),
        loadFile('../emu/github/emu8/kim1/KIM-1_65302.bin', false),
        loadFile('../emu/github/emu8/kim1/KIM-1_65303.bin', false)
    ];
