...
async function main() {
    let loads = [
        ...
        loadScript('../8086/chipset.js'),
        loadFile('../8086/basic.bin', false),
        loadFile('../8086/bios2.bin', false),
        loadFile('../8086/ibm_ega.bin', false)
    ];
    ...
    mem.DRIVES[2] = await DOSDisk('../8086/hdc.img');                 // C:
